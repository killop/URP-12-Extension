...
namespace UnityEngine.Rendering.Universal
{
    ...
    public partial class UniversalRenderPipelineAsset : RenderPipelineAsset, ISerializationCallbackReceiver
    {
        ...
        public float renderScale
        {
            get
            {
                bool hasValue = URPAdaptivePerformance.GetScreenScaleRadio(m_RenderScale, out var result);
                if (hasValue)
                {
                    return result;
                }
        ...
        public bool supportsMainLightShadows
        {
            get
            {
                bool hasValue = URPAdaptivePerformance.GetShadowEnable(m_MainLightShadowsSupported, out var result);
                if (hasValue)
                {
                    return result;
                }
        ...
        public int mainLightShadowmapResolution
        {
            get
            {
                bool hasValue = URPAdaptivePerformance.GetShadowResolution((int)m_MainLightShadowmapResolution, out var result);
                if (hasValue)
                {
                    return result;
                }
