...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PostProcessData : ScriptableObject
    {
        ...
        public Shader screenFadeShader;
#if UNITY_EDITOR
        ...
        public void ReloadScreenFadeShader() 
        {
            screenFadeShader = Shader.Find("Hidden/PostProcessing/TransitionSingleFocusSoft");
        }
