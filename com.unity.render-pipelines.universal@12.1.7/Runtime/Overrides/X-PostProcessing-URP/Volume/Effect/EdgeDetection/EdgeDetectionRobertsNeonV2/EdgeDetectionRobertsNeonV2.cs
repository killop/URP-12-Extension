...
{
    [VolumeComponentMenu(VolumeDefine.EdgeDetection + "RobertsNeonV2")]
    public class EdgeDetectionRobertsNeonV2 : VolumeSetting
    {
        ...
        {
            return "Hidden/PostProcessing/EdgeDetection/RobertsNeonV2";
        }
    }

    public class EdgeDetectionRobertsNeonV2Renderer : VolumeRenderer<EdgeDetectionRobertsNeonV2>
    {
        private const string PROFILER_TAG = "EdgeDetectionRobertsNeonV2";
